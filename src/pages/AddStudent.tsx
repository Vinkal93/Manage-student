      ...
      <div className="max-w-lg mx-auto space-y-6">
        <div className="bg-card rounded-xl border border-border shadow-sm p-6 text-center space-y-4">
          ...
          <div className="flex gap-3">
            <Button variant="outline" className="flex-1" onClick={() => { setNewStudent(null); setForm({ name: '', fatherName: '', mobile: '', whatsappNumber: '', course: '', admissionDate: new Date().toISOString().split('T')[0], feeAmount: 500, password: 'sbci123' }); setErrors({}); }}>
              Add Another
            </Button>
